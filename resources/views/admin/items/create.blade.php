...
<x-slot name="header">
    ...
    <form class="max-w-4xl p-8 rounded-md mx-auto  bg-white" action="{{ route('items.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
        <div class="mb-5">
        ...
        <div class="mb-5">
            ...
            <option value="" disabled selected class="text-gray-400">-- Pilih Merek / Brand --</option>
        ...
        <div class="mb-5">
            ...
            <input value="{{ old('features') }}" type="text" name="features" id="features"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" 
             />
