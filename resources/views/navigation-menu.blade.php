<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('admin.dashboard') }}">
                        <h1 class="font-bold text-xl text-green-700 leading-tight">Rentals</h1>
                    </a>
                </div>

                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('front.index') }}" :active="request()->routeIs('front.index')">
                        {{ __('Home') }}
                    </x-jet-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('items.index') }}" :active="request()->routeIs('items.index')">
                {{ __('Items') }}
            </x-jet-responsive-nav-link>
        </div>
        
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('brands.index') }}" :active="request()->routeIs('brands.index')">
                {{ __('Brands') }}
            </x-jet-responsive-nav-link>
        </div>
        <div class="pt-2 pb-3 space-y-1">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('bookings.index') }}" :active="request()->routeIs('bookings.index')">
                {{ __('Bookings') }}
            </x-jet-responsive-nav-link>
        </div>
